        ...
        <Dialog open={open} onClose={handleClose} PaperProps={{ sx: { maxWidth: 'unset' } }}>
            <Component>
                ...
                </Image>
                {
                    account.view==='login' ?
                    <Wrapper>
                        <TextField variant='standard' name='email' onChange={(e)=>onvalueChange(e)} label='Enter Email/mobile Number' />
                        <TextField variant='standard' type='password' name='password' onChange={(e)=>onvalueChange(e)} label='Enter Password' />
                    ...
                    <Wrapper>
                        ...
                        <TextField variant='standard' label='Enter Email Address' name='email' onChange={(e)=>onInputChange(e)} />
                        <TextField variant='standard' type='password' label='Enter Password' name='password' onChange={(e)=>onInputChange(e)} />
                        <TextField variant='standard' label='Enter Mobile Number' name='mobile' onChange={(e)=>onInputChange(e)} />
                        <Text>By continuing, you agree to Flipkart's Terms of Use and Privacy Policy. </Text>
